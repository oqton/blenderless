...
- For the script to work, all objects have to be scaled to 0.1x size (world origin as pivot) manually before running
- Materials and nodegroups still need to be imported, would be great if the file already included them.
"""
...
# Initial steps
# - [Scale entire scene down to 0.1x scale, with world origin as pivot point]
